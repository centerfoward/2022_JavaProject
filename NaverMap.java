...
public class NaverMap implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		String clientId = "ffim576nq8";
		String clientSecret = "4r2P2mN6rjDdnTOHY42Y9efdmAoqx7Srq8lUA2s3";
		AddressVO vo = null;
		...
		try {
			...
			for (int i = 0; i < (arr.length()); i++) {
				...
				//vo.setFirstAddress((String) temp.get("FirstAddress"));
	...
	public void map_service(AddressVO vo) {
		...
		try {
			...
			URL_STATICMAP += "&level=15&w=800&h=600"; //16 700 500
			...
			HttpURLConnection con = (HttpURLConnection) url.openConnection();
			con.setRequestMethod("GET");
			con.setRequestProperty("X-NCP-APIGW-API-KEY-ID", "ffim576nq8");
			con.setRequestProperty("X-NCP-APIGW-API-KEY", "4r2P2mN6rjDdnTOHY42Y9efdmAoqx7Srq8lUA2s3");
			...
			if (responseCode == 200) {
				...
				//naverMap.FirstAddress.setText(vo.getFirstAddress());
